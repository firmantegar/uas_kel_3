...
import com.example.uas_kel_3.network.AppDatabase
import com.example.uas_kel_3.network.FavoriteUtils
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        product?.let { product ->
            ...
            lifecycleScope.launch {
                ...
                buttonFavorite.setImageResource(if (isFavorite) R.drawable.ic_favorite else R.drawable.ic_favorite_border)
            }

            buttonFavorite.setOnClickListener {
                FavoriteUtils.saveToFavorite(applicationContext, lifecycleScope, product) { added, removed ->
                    runOnUiThread {
                        buttonFavorite.setImageResource(if (added) R.drawable.ic_favorite else R.drawable.ic_favorite_border)
                        if (added) {
